...
--               d:/AC701-tutorials/tutorial_1/tutorial_1.gen/sources_1/bd/design_1/ip/design_1_clock_divider_0_0/design_1_clock_divider_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_clock_divider_0_0_clock_divider is
  ...
  signal counter_reg : STD_LOGIC_VECTOR ( 25 downto 5 );
...
begin
clk_1Hz_i_1: unisim.vcomponents.LUT6
    generic map(
...
clk_1Hz_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
clk_1Hz_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
clk_1Hz_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
entity design_1_clock_divider_0_0 is
  ...
  attribute X_CORE_INFO of design_1_clock_divider_0_0 : entity is "clock_divider,Vivado 2022.1.1";
