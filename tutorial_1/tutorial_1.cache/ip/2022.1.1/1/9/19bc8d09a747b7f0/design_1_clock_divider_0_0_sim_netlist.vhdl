...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_divider is
  ...
  signal lcd_10 : STD_LOGIC;
  signal lcd_1_i_2_n_0 : STD_LOGIC;
  signal lcd_1_i_3_n_0 : STD_LOGIC;
  signal lcd_1_i_4_n_0 : STD_LOGIC;
  signal lcd_1_i_5_n_0 : STD_LOGIC;
  signal lcd_1_i_6_n_0 : STD_LOGIC;
  signal lcd_1_i_7_n_0 : STD_LOGIC;
  signal lcd_2_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_7\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of lcd_1_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of lcd_2_i_1 : label is "soft_lutpair0";
begin
...
lcd_1_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00008000"
    )
        port map (
...
lcd_1_i_2: unisim.vcomponents.LUT6
    generic map(
...
lcd_1_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
lcd_1_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
lcd_1_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
lcd_1_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
lcd_1_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
lcd_1_reg: unisim.vcomponents.FDRE
     port map (
      C => clk_in,
      CE => '1',
      D => lcd_10,
...
lcd_2_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFFFFFF"
    )
        port map (
...
lcd_2_reg: unisim.vcomponents.FDRE
     port map (
      C => clk_in,
      CE => '1',
      D => lcd_2_i_1_n_0,
